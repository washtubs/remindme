...
cat <<"USAGE"
Usage:
remindme <timespec> -- <reminder>
remindme +[id]... update <timespec> [ -- <reminder> ]
remindme mark-read +[id]
remindme show-unread
remindme show-upcoming (NOT IMPLEMENTED YET)

[id]:
5-letter string generated by mktemp identifying a reminder.

<timespec>:
in <duration> | at <time>
timespec makes the string which gets passed to `date --date=`
Examples:
    remindme in 5 minutes ...  --> date --date="now + 5 minutes"
    remindme at 4:00 ...  --> date --date="4:00"

<reminder>:
string to help your brain not be stupid.
USAGE
